            ...
            <div className='grid grid-cols-1 sm:grid-cols-12'>
                <div className='col-span-5 place-self-center '>
                    <div className="rounded-full bg-[#181818] w-[200px] h-[200px] lg:w-[400px] lg:h-[400px] relative">
                        <img src='/images/bxs-chat.svg' alt='aboutlogo' className='absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2' width={200} height={200} style={{ filter: 'invert(100%)' }}/>
                    </div>
                </div>
