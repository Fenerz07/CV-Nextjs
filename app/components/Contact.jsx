    ...
    return (
        <section className='mt-10 grid grid-cols-1 sm:grid-cols-2'>
            <div className='m-8 text-center sm:text-left'>
                <h1 className='font-extrabold text-xl mb-3 text-white '>My Socials Networks</h1>
                <p className='text-white'>I&apos;m always looking for new meets and oppotunities.
            ...
            <div className='place-self-top text-center'>
                ...
                <a href="mailto:hugom2005@free.fr" className='text-white'>hugom2005@free.fr</a>
            </div>
        </section>
    )
}
